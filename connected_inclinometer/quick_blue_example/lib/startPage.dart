          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                items:
                    actionsList.map<DropdownMenuItem<String>>((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value),
                  );
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => inclinometer(
                              globals: widget.globals,
                            )),
                  );
                },
                child: Text('Inclinometer'),
              ),
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Visualization3DPage(
                          globals: widget.globals,
                          )
                        ),
                  );
                },
                child: Text('Visualization 3D'),
              ),
            ],
          ),
        ),
